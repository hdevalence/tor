...
struct ed25519_zip215vector {
  const char *pub;
  const char *sig;
};

struct ed25519_zip215vector zip215vectors[] = 
{
	{
...
static void
test_crypto_ed25519_zip215vectors(void *arg)
{
  (void)arg;
...
static void
test_crypto_ed25519_zip215vectors_batch(void *arg)
{
  (void)arg;
...
// batch verify impl only kicks in after size 4
static void
test_crypto_ed25519_zip215vectors_batch4(void *arg)
{
  (void)arg;
...
struct testcase_t crypto_tests[] = {
  ...
  ED25519_TEST(zip215vectors, 0),
  ED25519_TEST(zip215vectors_batch, 0),
  ED25519_TEST(zip215vectors_batch4, 0),
